<template>
  ...
  >
    ...
    <div class="hero-copy relative z-10 w-full max-w-4xl">
      <p
        class="text-[10px] uppercase tracking-[0.25em] text-neutral-300 font-bold mb-2"
      >
        {{ t("hero.eyebrow") }}
      </p>
      <h1
      ...
      <p
        class="text-sm sm:text-base text-neutral-300 mb-8 max-w-2xl leading-relaxed"
      >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <span
            ...
            >{{ t("hero.meta.nextLaunch") }}</span
          >
          <strong
            class="block text-lg sm:text-xl font-bold text-white mt-2 font-mono"
            >{{ nextLaunchTimeFormatted }}</strong
          >
        </UCard>
        ...
        >
          ...
          <div class="flex gap-5 items-center">
            ...
            >
              <div
                class="text-xl sm:text-2xl font-bold text-white font-mono leading-none relative"
              >
                {{ countdown[unit] }}
              </div>
              <div
                class="text-[9px] uppercase tracking-wider text-neutral-400 mt-1.5 font-bold"
              >
...
defineProps({
  nextLaunch: { type: Object, default: null },
  countdown: { type: Object, required: true },
  heroStyle: { type: Object, default: () => ({}) },
  nextLaunchTitle: { type: String, required: true },
  nextLaunchDescription: { type: String, required: true },
  nextLaunchTimeFormatted: { type: String, required: true },
});
